...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
     ...
     *这里使用一款github较多人使用的 WMPageController 地址https://github.com/wangmchn/WMPageController
     */
...
-(UIView *)loadViewUI{
    ...
    NSArray *subTitle = [NSArray arrayWithObjects:@"商品详情",@"信用情况",@"用户评论",nil]; //RevisionofTSupplyChaincontroller.h ThesupplychainVixxewController
...
-(void)loadheadview{
    ...
    [joinSoppingbtn setTitle:@"联系卖家" forState:UIControlStateNormal];
