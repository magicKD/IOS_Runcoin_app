...
-(void)loaddateUI{
    ...
    NSArray *arr=@[@"https://www.bkchina.cn/website//productimage/5cc6dabea293f.png",@"https://www.bkchina.cn/website//productimage/5cc15113c1369.png"];
   ...
   _sdcylescrollview.imageURLStringsGroup = arr;
    ...
    [self uilabe:titlelaeb Color:AlltexthighlightedColor Nstring:@"绝版美利坚双层汉堡" Font:GHSonBole(sizecenter)];
    ...
    [self uilabe:Courierlabe Color:AlltextgrayColor Nstring:@"" Font:GHFont(sizemin)];
    ...
    [self uilabe:collectionlbae Color:AlltextgrayColor Nstring:@"" Font:GHFont(sizemin)];
    ...
    [self uilabe:mothlabe Color:AlltextgrayColor Nstring:@"" Font:GHFont(sizemin)];
    ...
    [self uilabe:addresslabe Color:AlltextgrayColor Nstring:@"" Font:GHFont(sizemin)];
    ...
    [self uilabe:listinglabe Color:AlltextgrayColor Nstring:@"卖家地址" Font:GHFont(sizemin)];
    ...
    [self uilabe:pricelabe Color:AllxianBinColor Nstring:@"¥:0元" Font:GHSonBole(sizecenter+3)];
