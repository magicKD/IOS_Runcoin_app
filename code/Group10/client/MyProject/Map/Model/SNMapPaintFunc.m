...
@interface SNMapPaintFunc () <MAMapViewDelegate>

@property (nonatomic, strong) SNMapAnnotation *startAnnotation;
@property (nonatomic, strong) SNMapAnnotation *endAnnotation;

@end

@implementation SNMapPaintFunc
...
- (void)addStartAnnotation:(SNMapAnnotation *)startAnnotation
             endAnnotation:(SNMapAnnotation *)endAnnotation
...
{
    if ([annotation isKindOfClass:[SNMapAnnotation class]])
    {
