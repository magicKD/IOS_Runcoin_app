...
@interface SNTransactionCateAnimationLogin()<UITextFieldDelegate>
...
@implementation SNTransactionCateAnimationLogin
...
-(void)drawView
{
    ...
    _userNameTextField.placeholder = @"请输入对方地址";
    NSLog(@"mao:%@", self.address);
    if (self.address && self.address.length > 0){
        _userNameTextField.text = self.address;
    }
...
//    _PassWordTextField.secureTextEntry = YES;
    _PassWordTextField.placeholder = @"请输入转账金额";
