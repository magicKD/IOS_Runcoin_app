...
- (void)viewDidLoad
{
    ...
    _labelName.text = @"张三"; //delegate.userInfomation.name;
    _labelPhone.text = @"400823823"; //delegate.userInfomation.phone;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 1)
    {
        ...
        cell.imageView1.image = [UIImage imageNamed:@"ham"];
        cell.labelCount.text = @"零食";
    ...
    if (indexPath.row == 0)
    {
        ...
        cell.imageView.image = [UIImage imageNamed:@"gotoShoppingCart"];
    }
    else if (indexPath.row == 2)
    {
        cell.textLabel.text = @"购买数量";
        cell.detailTextLabel.text = @"1";//[NSString stringWithFormat:@"%d",_goodsYouPayNow.countOfNeed];
    }
